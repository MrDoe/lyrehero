...
export const PRESET_SONGS: Song[] = [
  {
    ...
    notes: [
      // Section A
      { note: "C4", lyric: "Twin" }, { note: "C4", lyric: "kle" },
      { note: "G4", lyric: "Twin" }, { note: "G4", lyric: "kle" },
      { note: "A4", lyric: "Lit" }, { note: "A4", lyric: "tle" },
      { note: "G4", lyric: "Star" },
      { note: "F4", lyric: "How" }, { note: "F4", lyric: "I" },
      { note: "E4", lyric: "Won" }, { note: "E4", lyric: "der" },
      { note: "D4", lyric: "What" }, { note: "D4", lyric: "You" },
      { note: "C4", lyric: "Are" },
      // Section B
      { note: "G4", lyric: "Up" }, { note: "G4", lyric: "a" },
      { note: "F4", lyric: "bove" }, { note: "F4", lyric: "the" },
      { note: "E4", lyric: "world" }, { note: "E4", lyric: "so" },
      { note: "D4", lyric: "high" },
      { note: "G4", lyric: "Like" }, { note: "G4", lyric: "a" },
      { note: "F4", lyric: "dia" }, { note: "F4", lyric: "mond" },
      { note: "E4", lyric: "in" }, { note: "E4", lyric: "the" },
      { note: "D4", lyric: "sky" },
      // Section A Repeat
      { note: "C4", lyric: "Twin" }, { note: "C4", lyric: "kle" },
      { note: "G4", lyric: "Twin" }, { note: "G4", lyric: "kle" },
  ...
  },
  {
    ...
    notes: [
      // Part 1
      { note: "E4", lyric: "Joy" }, { note: "E4", lyric: "ful" },
      { note: "F4", lyric: "Joy" }, { note: "G4", lyric: "ful" },
      { note: "G4", lyric: "We" }, { note: "F4", lyric: "A" },
      { note: "E4", lyric: "dore" }, { note: "D4", lyric: "Thee" },
      { note: "C4", lyric: "God" }, { note: "C4", lyric: "of" },
      { note: "D4", lyric: "Glo" }, { note: "E4", lyric: "ry" },
      { note: "E4", lyric: "Lord" }, { note: "D4", lyric: "of" },
      { note: "D4", lyric: "Love" },
      // Part 2
      { note: "E4", lyric: "Hearts" }, { note: "E4", lyric: "un" },
      { note: "F4", lyric: "fold" }, { note: "G4", lyric: "like" },
      { note: "G4", lyric: "flowers" }, { note: "F4", lyric: "be" },
      { note: "E4", lyric: "fore" }, { note: "D4", lyric: "Thee" },
      { note: "C4", lyric: "Hail" }, { note: "C4", lyric: "Thee" },
      { note: "D4", lyric: "as" }, { note: "E4", lyric: "the" },
      { note: "D4", lyric: "sun" }, { note: "C4", lyric: "a" },
      { note: "C4", lyric: "bove" }
    ]
  },
  {
    ...
    notes: [
      { note: "G3", lyric: "A" },
      { note: "C4", lyric: "ma" }, { note: "E4", lyric: "zing" },
      { note: "C4", lyric: "Grace" },
      { note: "E4", lyric: "How" },
      { note: "D4", lyric: "Sweet" },
      { note: "C4", lyric: "The" },
      ...
      { note: "C4", lyric: "Saved" },
      { note: "E4", lyric: "A" },
      { note: "C4", lyric: "Wretch" },
      { note: "E4", lyric: "Like" },
      { note: "G4", lyric: "Me" },
      // Part 2
      { note: "E4", lyric: "I" },
      { note: "G4", lyric: "once" }, { note: "E4", lyric: "was" },
      { note: "G4", lyric: "lost" },
      { note: "E4", lyric: "but" },
      { note: "C4", lyric: "now" }, { note: "A3", lyric: "am" },
      { note: "G3", lyric: "found" },
      { note: "G3", lyric: "Was" },
      { note: "C4", lyric: "blind" }, { note: "E4", lyric: "but" },
      { note: "C4", lyric: "now" },
      { note: "E4", lyric: "I" },
      { note: "D4", lyric: "see" },
      { note: "C4", lyric: "-" }
